...
interval = (1, 15)     #Search range when simulating the quantification of the fractional part of the parameters.
...
for n_iter in range(simulations):
    ...
    def f(x,alpha,beta,gamma):
        ...
        actual_acc= model.evaluate(x_test,  y_test, verbose=0)[1]*factor
        a,b=interval
    ...
    actual_acc= model.evaluate(x_test,  y_test, verbose=0)[1]
    #----------------------- 
